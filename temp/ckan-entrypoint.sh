...
IFS=@ read CREDENTIALS CONNECTION <<< $CKAN_SQLALCHEMY_URL
IFS=/ read PG_DB SCHEMA <<< $CREDENTIALS
IFS=// read CONN_TYPE PG_CREDS <<< $CONNECTION
IFS=: read PG_USER PG_PASS <<< $PG_CREDS
# Wait for PostgreSQL
